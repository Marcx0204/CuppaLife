                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="card border-secondary mb-3">
                                    ...
                                    <div class="card-body text-secondary">
                                        <p>Indem Sie ein Konto in unserem Shop erstellen, können Sie den Bestellvorgang
                                            schneller durchlaufen, mehrere Lieferadressen speichern, Ihre Bestellungen
                                            anzeigen und verfolgen und vieles mehr.</p>
                            ...
                            <div class="col-md-6">
                                <div class="card border-secondary mb-3">
                                    ...
                                    <div class="card-body text-secondary">
                                        <div id="error"
                                            style="display:none; background: #c05353;color: #fff;padding: 10px;border-radius: 7px;text-align: center;margin-bottom: 10px;">
                                        </div>
                                        <form id="form">
                                            <div class="form-group col-md-11">
                                                <label for="username">Benutzername oder Email*</label>
                                                <input type="text" class="form-control" id="username" name="username"
                                                    placeholder="Benutzername oder Email" required>
                                            </div>
